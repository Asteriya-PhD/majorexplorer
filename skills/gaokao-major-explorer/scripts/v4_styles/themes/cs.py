...
/* 6. overview_v2 redesign — AI 等 cs 主题深色背景 (Day 23 06-22 二次发现: 速览 Foundations section 还是浅色) */
section.tab .ovv-card {
  background: rgba(11, 17, 32, 0.5); border-color: #1F2937;
  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.3);
}
section.tab .ovv-card::before { background: #22C55E; }
section.tab .ovv-card.is-blue::before { background: #22C55E; }
section.tab .ovv-card.is-orange::before { background: #F87171; }
section.tab .ovv-card-head { border-bottom-color: rgba(255, 255, 255, 0.1); }
section.tab .ovv-card-num { color: #22C55E; }
section.tab .ovv-card-title { color: #F8FAFC; }
section.tab .ovv-card-tag { color: #94A3B8; }
section.tab .ovv-foundations-label,
section.tab .ovv-directions-label { color: #94A3B8; }
section.tab .ovv-timeline::before { background: linear-gradient(90deg, transparent, #22C55E 20%, #22C55E 80%, transparent); }
section.tab .ovv-tl-step::before { background: #0B1120; border-color: #22C55E; }
section.tab .ovv-tl-step span { color: #F8FAFC; }
section.tab .ovv-dir {
  background: rgba(11, 17, 32, 0.4); border-color: #1F2937;
}
section.tab .ovv-dir:hover { border-color: #22C55E; background: rgba(34, 197, 94, 0.06); }
section.tab .ovv-dir-num { color: #22C55E; }
section.tab .ovv-dir-name { color: #F8FAFC; }
section.tab .ovv-dir-desc { color: #94A3B8; }
section.tab .ovv-skill {
  background: rgba(11, 17, 32, 0.4); border-color: #22C55E; color: #22C55E;
}
section.tab .ovv-bonus {
  background: rgba(184, 144, 42, 0.08); border-left-color: #B8902A; color: #F8FAFC;
}
/* v2 fit-check (与 simple 不同的类名 .ovv-fit-col 不是 .ovv-simple-fit-col) */
section.tab .ovv-fit-col {
  background: rgba(11, 17, 32, 0.4); border-color: #1F2937;
}
section.tab .ovv-fit-col.is-yes {
  border-left: 3px solid #22C55E;
  background: linear-gradient(135deg, rgba(34, 197, 94, 0.08), rgba(11, 17, 32, 0.4));
}
section.tab .ovv-fit-col.is-no {
  border-left: 3px solid #F87171;
  background: linear-gradient(135deg, rgba(248, 113, 113, 0.08), rgba(11, 17, 32, 0.4));
}
section.tab .ovv-fit-col.is-yes .ovv-fit-label { color: #22C55E; }
section.tab .ovv-fit-col.is-no .ovv-fit-label { color: #F87171; }
section.tab .ovv-fit-list li {
  color: #F8FAFC; border-bottom-color: rgba(255, 255, 255, 0.08);
}
