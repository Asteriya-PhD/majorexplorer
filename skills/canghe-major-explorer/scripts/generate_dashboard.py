...
STYLE_TOKENS = {
  ...
  "tech": {
    ...
    "colors": {
      ...
      "primary":     "#A78BFA",
      "primary_dim": "#6366F1",
      "primary_glow":"rgba(167, 139, 250, 0.20)",
      "surface":     "rgba(99, 102, 241, 0.06)",
      "surface_alt": "rgba(34, 211, 238, 0.04)",
      "border":      "#312E81",
      "border_strong":"#4338CA",
      "accent":      "#A78BFA",
      "accent_2":    "#22D3EE",
      "accent_glow": "rgba(167, 139, 250, 0.20)",
      "monogram_bg": "#A78BFA",
      "monogram_fg": "#0A0E27",
      "shadow":      "0 1px 0 rgba(167, 139, 250, 0.08), 0 8px 32px rgba(0, 0, 0, 0.3)",
      "shadow_hover":"0 1px 0 rgba(167, 139, 250, 0.25), 0 12px 40px rgba(167, 139, 250, 0.15)",
    },
    "decor": "◆ {title} ◆",
    "label": "TECH",
    "tagline": "暗紫 + 青绿 + 几何, 非终端",
    "hero_align": "left",
    "hero_decor_extra": " · AURORA",
    "hero_layout": "v2",
  ...
  "tech_kiro": {
    ...
    "colors": {
      ...
      "primary":     "#E8C547",
      "primary_dim": "#C9A3D8",
      "primary_glow":"rgba(232, 197, 71, 0.20)",
      "surface":     "rgba(42, 31, 71, 0.4)",
      "surface_alt": "rgba(201, 163, 216, 0.06)",
      "border":      "#443657",
      "border_strong":"#6B4F8C",
      "accent":      "#E8C547",
      "accent_glow": "rgba(232, 197, 71, 0.20)",
      "monogram_bg": "#E8C547",
      "monogram_fg": "#1F1A2E",
      "shadow":      "0 1px 0 rgba(232, 197, 71, 0.08), 0 8px 32px rgba(0, 0, 0, 0.4)",
      "shadow_hover":"0 1px 0 rgba(232, 197, 71, 0.25), 0 12px 40px rgba(232, 197, 71, 0.15)",
    },
    "decor": "✦ {title} ✦",
    "label": "STELLAR",
    "tagline": "暖暗紫 + 暖金 + 星空",
  ...
  "tech_qoder": {
    ...
    "colors": {
      ...
      "primary":     "#5C7C5A",
      "primary_dim": "#8B9D7F",
      "primary_glow":"rgba(92, 124, 90, 0.20)",
      "surface":     "#FFFFFF",
      "surface_alt": "#F7F5EF",
      "border":      "#C5B89A",
      "border_strong":"#5C7C5A",
      "accent":      "#5C7C5A",
      "accent_glow": "rgba(92, 124, 90, 0.20)",
      "monogram_bg": "#5C7C5A",
      "monogram_fg": "#F7F5EF",
      "shadow":      "0 1px 0 rgba(92, 124, 90, 0.04), 0 4px 12px rgba(92, 124, 90, 0.06)",
      "shadow_hover":"0 1px 0 rgba(92, 124, 90, 0.10), 0 8px 24px rgba(92, 124, 90, 0.10)",
    },
    "decor": "❀ {title} ❀",
    "label": "ATELIER",
    "tagline": "鼠尾草绿 + 米白 + 自然手作",
    "hero_align": "left",
    "hero_decor_extra": " · CRAFTSMAN",
    "hero_layout": "v2",
    "mouse_cursor": "default",
  },
  "tech_workbuddy": {
    ...
    "colors": {
      ...
      "primary":     "#2C5F6F",
      "primary_dim": "#1A3D47",
      "primary_glow":"rgba(44, 95, 111, 0.10)",
      "surface":     "#FFFFFF",
      "surface_alt": "#E8F0F1",
      "border":      "#C5D4D7",
      "border_strong":"#8FB8C2",
      "accent":      "#F0A868",
      "accent_glow": "rgba(240, 168, 104, 0.20)",
      "monogram_bg": "#2C5F6F",
      "monogram_fg": "#FAFAF6",
      "shadow":      "0 1px 0 rgba(44, 95, 111, 0.04), 0 4px 12px rgba(44, 95, 111, 0.06)",
      "shadow_hover":"0 1px 0 rgba(44, 95, 111, 0.10), 0 8px 24px rgba(44, 95, 111, 0.10)",
    },
    "decor": "▣ {title} ▣",
    "label": "OFFICE",
    "tagline": "暖白 + 深青 + 阳光橘",
    "hero_align": "left",
    "hero_decor_extra": " · WORKPLACE",
    "hero_layout": "v2",
    "mouse_cursor": "default",
  },
  "finance": {
