...
ALUMNI_FILLERS = {
    ...
    "law_商法/经济法": [
        {"tag": "商事律师 · 5 年", "quote": "商法/经济法是法学里最商业的学科, 公司/证券/金融/反垄断方向, 学完能看懂上市公司公告+并购重组方案。本科毕业去金杜汉坤, 商法基础是关键。", "school": "某 985 高校商法方向 2018 届"},
        {"tag": "投行/PE 法务 · 4 年", "quote": "从律所转投行法务, 商法+证券法+公司法是日常工具, IPO/再融资/并购重组每个项目背后是数百页尽调材料。", "school": "某政法院校经济法方向 2019 届硕士"},
        {"tag": "证监会公务员", "quote": "商法+经济法方向考证监会, 录取后做的都是 IPO 审核/上市公司监管/证券违法稽查, 实务比课本复杂 100 倍, 但法理基础够扎实上手很快。", "school": "某 985 高校商法方向 2020 届硕士"},
    ],
    "law_诉讼法": [
