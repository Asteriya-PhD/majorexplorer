...
- ⚠️ 备案时需按 ADR-019 策略 (普通个人身份, 不暴露教师身份)
...
**日期**: 2026-06-12
**状态**: ✅ 锁定 (留作 ADR-018 触发后的执行策略)
**对应 plan**: `docs/DEPLOYMENT.md` v2 阶段 4

### 上下文
教师身份做教育内容网站的两面性:
- ✅ 加分: 北京/上海/江苏教育类备案有绿色通道, 部分省快 1-3 天
- ❌ 风险: 备案系统暴露学校+姓名, 教育局/学校可查; 教师副业受处分规定约束; 商业化元素触碰红线

中国大陆 2026 现状:
- 在编教师校外有偿补课/兼职: 政策红线
- 教师做"公益教育网站": 政策上鼓励, 但**审核员主观判断差异极大**
- 备案系统里"在职证明"暴露: 直属教育局可见
- 公众号/媒体转载: 可能引发教育局关注

### 决定
**未来备案时, 采用普通个人身份, 不主动暴露教师身份**:
...
网站内容/文案 4 条红线:
- "志愿填报咨询" (教培类, 需资质) → "高考专业信息查询" (信息聚合, 允许)
- "教师团队" "教育专家" → "开发者" "产品团队"
- "教学" "辅导" "课程" → 全文不出现
- "在线答疑" "咨询入口" → 不做, 不留
...
网站底部必须加 2 段声明:
```
① 本站为非营利性高考专业信息聚合工具, 所有内容均来自公开信息源。
② 本站不提供任何形式的教育咨询、培训、答疑或志愿填报服务, 
   用户决策应结合官方招生考试机构与所在中学指导。
```

### 后果
- ✅ 备案信息不进教育系统, 教育局/学校不感知
- ✅ 商业化灵活: 未来加广告/付费, 主体已与教师身份解耦
- ✅ 不享受教育类绿色通道 (损失 1-3 天), 但风险敞口消失
- ⚠️ 部分省份对"教育内容" 个人备案**仍要求** 承诺书
- ⚠️ 网站流量起来后, 教师身份**有可能被技术手段扒出** (博客/微博/历史内容), 需持续警惕
